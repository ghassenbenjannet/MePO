...
export const spaces: Space[] = [
  {
    ...
    status: "Active",
    progress: 62,
    summary: "Execution hub for major PO topics, ticket flow, documentation, and AI-assisted delivery.",
  },
  {
    id: "release-2026-1",
    projectId: "hcl-livret",
    ...
    status: "Planning",
    progress: 34,
    summary: "Focused perimeter for release preparation, cutover risks, and validation scope.",
  },
];
